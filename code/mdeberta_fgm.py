...
CFG = { #训练的参数配置
    'seed': 1,
    'model': 'microsoft/mdeberta-v3-base', #预训练模型
...
def train_model(model, fgm,pgd,train_loader,epoch):  # 训练一个epoch
    ...
    for step, (input_ids, attention_mask, token_type_ids,y) in enumerate(tk):
        ...
        output2 = model(input_ids, attention_mask=attention_mask, token_type_ids=token_type_ids, labels=y)
        loss2 = output2.loss
