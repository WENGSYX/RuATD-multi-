...
CFG = { #训练的参数配置
    'seed': 1,
    'model': r'microsoft/mdeberta-v3-base', #预训练模型
    'max_len': 280, #文本截断的最大长度
    'epochs': 16,
...
from Adamw_D import ChildTuningAdamW as AdamW
optimizer = AdamW(model,model.parameters(),lr=CFG['lr'], weight_decay=CFG['weight_decay'])
